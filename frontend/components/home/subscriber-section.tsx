            ...
            <div className="mx-auto w-11/12 lg:w-8/12">
                ...
                <div className="relative overflow-hidden rounded-3xl bg-primary px-6 py-14 sm:px-12 sm:py-16 text-center">
                    ...
                    <div className="relative z-10">
                        ...
                        <form
                            onSubmit={undefined}
                            className="mt-8 max-w-xl mx-auto flex flex-col md:flex-row items-center gap-3 md:gap-0 md:bg-white md:rounded-full md:overflow-hidden md:shadow-lg"
                        >
                            <input
                                type="email"
                                name="email"
                                ...
                                className="w-full md:flex-1 px-6 py-4 text-sm text-gray-700 outline-none bg-white rounded-full md:rounded-none placeholder:text-gray-400 shadow-lg md:shadow-none"
                            />
                            <button
                                type="submit"
                                className="w-full md:w-auto px-8 py-4 bg-[#800020] text-white text-sm font-semibold rounded-full hover:brightness-110 transition cursor-pointer whitespace-nowrap shadow-lg md:shadow-none"
                            >
                                {button}
                            </button>
                        </form>
